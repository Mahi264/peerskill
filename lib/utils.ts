 ...
 * - Department is NOT prepended in the public peer identity summary.
 ...
 * - branch="Information Technology (IT)", section="B", graduationYear=2027 -> "Information Technology (IT) • Section B • Class of 2027"
 */
export function formatPublicPeerAcademicSubtitle(profile: {
  ...
  const primaryAcademic = profile.branch?.trim() || profile.department?.trim() || "Campus Student";
